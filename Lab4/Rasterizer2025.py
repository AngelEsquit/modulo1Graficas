...
from shaders import vertexShader, rainbowFragmentShader, textureFragmentShader, toonFragmentShader
import math
...
if __name__ == "__main__":
    ...
    model_data.vertexShader = vertexShader  # Cambiado a vertex shader normal
    model_data.fragmentShader = rainbowFragmentShader  # Agregado fragment shader rainbow
    ...
    print("4 / 5 / 6 / 7: Cambiar fragment shader (Rainbow, Textura, Toon, Ninguno)")
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_1:
                    ...
                    print("Fragment shader cambiado a: Toon")
                elif event.key == pygame.K_7:
                    model_data.fragmentShader = None
                    print("Fragment shader desactivado")
